        ...
        <div class="containerZ">
            <div class="content">
                ...
                <form action="" method="post" id="add-ingredient-form">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <select name="saison" required>
                            ...
                            foreach ($saisons as $row) {
                                ?>
                                <option value="<?php echo $row['idSaison'] ?>">
                    ...
                    <input type="number" name="calories" class="mb-3" required>
                    <h5 class="mb-1">Glucides</h5>
                    <input type="number" name="glucides" class="mb-3">
                    <h5 class="mb-1">Lipides</h5>
                    <input type="number" name="lipides" class="mb-3">
                    <h5 class="mb-1">Minéreaux</h5>
                    <input type="number" name="mineraux" class="mb-3">
                    <h5 class="mb-1">Vitamines</h5>
                    <input type="text" name="vitamiens">
                    <hr>
